exports.startControl = function (config) {
    ...
    var fs = require('fs');
    // check modules from current directory,parent directory as well as node_modules
    ...
    var URL = require('url');
    http.createServer(require('../auth')(config.auth.user, config.auth.realm, function (req, res) {
